...
export function InformationTV(){
    ...
    useEffect(async () => {
        ...
        const { data } = await axios.get(
          BASE_URL +
            "/tv/"+id+"?api_key=96421fbbc5840b04b22117d3eed01980&language=en-US"
        );
      ...
      useEffect(async () => {
        const { data } = await axios.get(
          BASE_URL +
            "/tv/"+id+"/credits?api_key=96421fbbc5840b04b22117d3eed01980"
        );
            setCast(data.cast);
            setCrew(data.crew);
      }, []);
